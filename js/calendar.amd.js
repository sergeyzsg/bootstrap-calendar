...
(function($) {
	...
	Calendar.prototype._loadEvents = function(done) {
		var self = this;
		var source = null;
		...
		switch($.type(source)) {
			case 'function':
				loader = function(done) {
					done(source(self.options.position.start, self.options.position.end, browser_timezone));
				};
				break;
			case 'array':
				loader = function(done) {
	...
	Calendar.prototype._loadTemplate = function(name) {
		...
		self.options.templates[name] = _.template(
			require(this.options.tmpl_path + name + '.html')
		);
	};
